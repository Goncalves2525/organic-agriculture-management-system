...
CREATE TABLE CULTIVOS (QUINTAID number(10) NOT NULL, PARCELAID number(10) NOT NULL, CULTURAID number(10) NOT NULL, dataInicio date NOT NULL, dataFim date, quantidade number(10, 2) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, SETORREGAID number(10), PRIMARY KEY (PARCELAID, CULTURAID));
...
CREATE TABLE REGAS (OPERACAOID number(10) NOT NULL, quantidade number(10, 2) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, SETOR number(10) NOT NULL, PRIMARY KEY (OPERACAOID));
