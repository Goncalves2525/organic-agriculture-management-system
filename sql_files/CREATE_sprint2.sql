CREATE TABLE APLICACOES_FATPROD (OPERACAOID number(10) NOT NULL, FATORPRODID varchar2(255) NOT NULL, quantidade number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (OPERACAOID));
CREATE TABLE ARMAZENS (QUINTAID number(10) NOT NULL, EDIFICIOID number(10) NOT NULL, nome varchar2(255) NOT NULL, area number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (QUINTAID, EDIFICIOID));
...
CREATE TABLE COLHEITAS (OPERACAOID number(10) NOT NULL, quantidade number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (OPERACAOID));
...
CREATE TABLE CULTIVOS (QUINTAID number(10) NOT NULL, PARCELAID number(10) NOT NULL, CULTURAID number(10) NOT NULL, dataInicio date NOT NULL, dataFim date, quantidade number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, SETORREGAID number(10), PRIMARY KEY (PARCELAID, CULTURAID));
...
CREATE TABLE GARAGENS (QUINTAID number(10) NOT NULL, EDIFICIOID number(10) NOT NULL, nome varchar2(255) NOT NULL, area number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (QUINTAID, EDIFICIOID));
CREATE TABLE INCORPS_SOLO (OPERACAOID number(10) NOT NULL, quantidade number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (OPERACAOID));
CREATE TABLE MOBILIZACOES_SOLO (OPERACAOID number(10) NOT NULL, quantidade number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (OPERACAOID));
CREATE TABLE MOINHOS (QUINTAID number(10) NOT NULL, EDIFICIOID number(10) NOT NULL, nome varchar2(255) NOT NULL, area number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (QUINTAID, EDIFICIOID));
CREATE TABLE MONDAS (OPERACAOID number(10) NOT NULL, quantidade number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (OPERACAOID));
CREATE TABLE OPERACOES (idOperacao number(10) NOT NULL, QUINTAID number(10) NOT NULL, PARCELAID number(10) NOT NULL, CULTURAID number(10), OPERADORID number(10) NOT NULL, dataInicio date NOT NULL, dataFim date, PRIMARY KEY (idOperacao));
CREATE TABLE OPERADORES (idOperador number(10) NOT NULL, nome varchar2(255) NOT NULL, PRIMARY KEY (idOperador));
CREATE TABLE PARCELAS (QUINTAID number(10) NOT NULL, idParcela number(10) NOT NULL, nome varchar2(255) NOT NULL, area float(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (QUINTAID, idParcela));
CREATE TABLE PLANTACOES (OPERACAOID number(10) NOT NULL, quantidade number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (OPERACAOID));
CREATE TABLE PODAS (OPERACAOID number(10) NOT NULL, quantidade number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (OPERACAOID));
CREATE TABLE PRODUTOS (CULTURAID number(10) NOT NULL, produto varchar2(255) NOT NULL, quantidade number(10), UNIDADEMEDIDA varchar2(255), TIPOCONSUMOID number(10), PRIMARY KEY (CULTURAID, produto));
CREATE TABLE QUINTAS (idQuinta number(10) NOT NULL, nome varchar2(255) NOT NULL, PRIMARY KEY (idQuinta));
CREATE TABLE REGAS (OPERACAOID number(10) NOT NULL, quantidade number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, SETOR number(10) NOT NULL, PRIMARY KEY (OPERACAOID));
CREATE TABLE SEMENTEIRAS (OPERACAOID number(10) NOT NULL, quantidade number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (OPERACAOID));
CREATE TABLE SETORES_REGA (idSetor number(10) NOT NULL, QUINTAID number(10) NOT NULL, EDIFICIOID number(10) NOT NULL, dataInicio date NOT NULL, dataFim date, caudalMaximo number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (idSetor));
CREATE TABLE SISTEMAS_REGA (QUINTAID number(10) NOT NULL, EDIFICIOID number(10) NOT NULL, nome varchar2(255) NOT NULL, area number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (QUINTAID, EDIFICIOID));
CREATE TABLE SUBSTANCIAS (idSubstancia number(10) NOT NULL, substancia varchar2(255) NOT NULL, percentagem number(10) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, PRIMARY KEY (idSubstancia));
...
ALTER TABLE OPERACOES ADD CONSTRAINT FKOPERACOES12411 FOREIGN KEY (PARCELAID, CULTURAID) REFERENCES CULTIVOS (PARCELAID, CULTURAID);
