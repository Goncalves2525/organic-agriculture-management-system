...
CREATE TABLE FERTIRREGAS (OPERACAOID number(10) NOT NULL, quantidade number(10, 2) NOT NULL, UNIDADEMEDIDA varchar2(255) NOT NULL, SETOR number(10) NOT NULL, RECEITAID number(10) NOT NULL, PRIMARY KEY (OPERACAOID));
...
CREATE TABLE MIX (idReceita number(10) GENERATED AS IDENTITY, PRIMARY KEY (idReceita));
...
CREATE TABLE RECEITAS (RECEITAID number(10) NOT NULL, FATORPRODID varchar2(255) NOT NULL, percentagem number(3, 2) NOT NULL, PRIMARY KEY (RECEITAID, FATORPRODID, percentagem));
